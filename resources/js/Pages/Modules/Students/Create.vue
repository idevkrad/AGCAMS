                    ...
                    <div class="col-md-10">
                        <b-form class="customform">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Birthday: <span v-if="form.errors" v-text="form.errors.birthday"
                                                class="haveerror"></span></label>
                                        <date-picker v-model:value="user.birthday" type="date" format="YYYY-MM-DD"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" v-model="user.birth_place"
                                                style="text-transform: capitalize;">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Religion: <span v-if="form.errors" v-text="form.errors.religion_id"
                                                class="haveerror"></span></label>
                                        <Multiselect v-model="user.religion" :options="religions" :allow-empty="false"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label>Sex: <span v-if="form.errors" v-text="form.errors.sex_id"
                                                class="haveerror"></span></label>
                                        <Multiselect v-model="user.sex" :options="genders" :allow-empty="false"
                                            :show-labels="false" label="name" track-by="id"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Civil Status: <span v-if="form.errors" v-text="form.errors.civil_id"
                                                class="haveerror"></span></label>
                                        <Multiselect v-model="user.civil_status" :options="civils" :allow-empty="false"
                                            :show-labels="false" label="name" track-by="id"
                                            placeholder="Select Civil Status" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Living Condition: <span v-if="form.errors" v-text="form.errors.living_id"
                                                class="haveerror"></span></label>
                                        <Multiselect v-model="user.living_condition" :options="livings"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label>Ethnic Affiliation: <span v-if="form.errors"
                                                v-text="form.errors.ethnic_id" class="haveerror"></span></label>
                                        <Multiselect v-model="user.ethnic" :options="ethnics" :allow-empty="false"
                                            :show-labels="false" label="name" track-by="id"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Language/Dialect Spoken: <span v-if="form.errors"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Zamboanga City Address: <span v-if="form.errors"
                                                v-text="form.errors.city_name" class="haveerror"></span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Telephone No.: <span v-if="form.errors"
                                                v-text="form.errors.city_telephone" class="haveerror"></span></label>
                                        <input type="text" class="form-control" v-model="user.city.telephone">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label>Mobile No.: <span v-if="form.errors" v-text="form.errors.city_mobile"
                                                class="haveerror"></span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Province Address: <span v-if="form.errors"
                                                v-text="form.errors.province_name" class="haveerror"></span></label>
                            ...
                            <div class="col-md-12">
                                <div class="">
                                    ...
                                    <div class="input-group me-2 mb-1">
                                        <label class="input-group-text">Name <span v-if="form.errors"
                                                v-text="form.errors" class="haveerror"></span></label>
                                        <input type="text" class="form-control" placeholder="Enter Name"
                                            style="width: 20%;" v-model="user.emergency.name" />
                                        <label class="input-group-text">Relation <span v-if="form.errors"
                                                v-text="form.errors" class="haveerror"></span> </label>
                                        <select v-model="user.emergency.relation" class="form-select"
                                            style="width: 17%;">
                                            <option value="" selected disabled>Select Relation</option>
                                        </select>
                                        <label class="input-group-text">Address<span v-if="form.errors"
                                                v-text="form.errors" class="haveerror"></span></label>
                                        <input type="text" class="form-control" placeholder="Enter Address"
                                            style="width: 20%;" v-model="user.emergency.address" />
                                        <label class="input-group-text">Phone<span v-if="form.errors"
                                                v-text="form.errors" class="haveerror"></span></label>
                                        <input type="text" class="form-control" placeholder="Enter Contact"
                                            style="width: 20%;" v-model="user.emergency.contact" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <b-form class="">
                            <div class="row mt-5">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group me-2 mb-1">
                                        <label class="input-group-text" style="width: 15%;">Grade School <span
                                                v-if="form.errors" v-text="form.errors"
                                                class="haveerror"></span></label>
                                        <input type="text" class="form-control" placeholder="Name of School"
                                            style="width: 30%;" v-model="user.emergency.name" />
                                        <input type="text" class="form-control" placeholder="Address"
                                            style="width: 30%;" v-model="user.emergency.contact" />
                                        <input type="text" class="form-control" placeholder="Year Graduated"
                                            style="width: 15%;" v-model="user.emergency.contact" />
                                        <input type="text" class="form-control" placeholder="GPA" style="width: 10%;"
                                            v-model="user.emergency.contact" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input-group me-2 mb-1">
                                        <label class="input-group-text" style="width: 15%;">High School <span
                                                v-if="form.errors" v-text="form.errors"
                                                class="haveerror"></span></label>
                                        <input type="text" class="form-control" placeholder="Name of School"
                                            style="width: 30%;" v-model="user.emergency.name" />
                                ...
                                <div class="col-md-12">
                                    <div class="input-group me-2 mb-1">
                                        <label class="input-group-text" style="width: 15%;">College <span
                                                v-if="form.errors" v-text="form.errors"
                                                class="haveerror"></span></label>
                                        <input type="text" class="form-control" placeholder="Name of School"
                                            style="width: 30%;" v-model="user.emergency.name" />
                        ...
                        <b-form class="customform">
                            <div class="row mt-5">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group mb-3">
                                        <label>Height: <span v-if="form.errors" v-text="form.errors.province_mobile"
                                                class="haveerror"></span></label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group mb-3">
                                        <label>Weight: <span v-if="form.errors" v-text="form.errors.province_mobile"
                                                class="haveerror"></span></label>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-3">
                                        <label>Physical and/or Learning Disabilities: <span v-if="form.errors"
                                                v-text="form.errors.province_mobile" class="haveerror"></span></label>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th class="align-middle">Do you?</th>
                                ...
                                <div class="col-md-8">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th class="align-middle">Have you?</th>
                                                    <th class="text-end">Yes</th>
                                                    <th class="text-end">No</th>
                                                </tr>
                                            </thead>
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-12" style="margin-top: -10px;">
                                            <label style="margin-bottom: -5px; font-size: 11px;">Father:</label>
                                            <div class="input-group me-2 mb-1">
                                                <input type="text" class="form-control" placeholder="Name" style="width: 30%;"/>
                                                <select v-model="user.emergency.relation" class="form-select" style="width: 25%;">
                                                    <option value="" selected disabled>Select Religion</option>
                                                </select>
                                                <input type="text" class="form-control" placeholder="Occupation" style="width: 25%;" />
                                                <input type="text" class="form-control" placeholder="Age" style="width: 7%;"/>
                                                <select v-model="user.emergency.relation" class="form-select" style="width: 13%;">
                                        ...
                                        <div class="col-md-12" style="margin-top: 4px;">
                                           <label style="margin-bottom: -5px; font-size: 11px;">Mother:</label>
                                            <div class="input-group me-2 mb-1">
                                                <input type="text" class="form-control" placeholder="Name" style="width: 30%;"/>
                                                <select v-model="user.emergency.relation" class="form-select" style="width: 25%;">
                                                    <option value="" selected disabled>Select Religion</option>
                                        ...
                                        <div class="col-md-12" v-if="user.civil_status.id == 6" style="margin-top: 4px;">
                                           <label style="margin-bottom: -5px; font-size: 11px;">Spouse:</label>
                                            <div class="input-group me-2 mb-1">
                                                <input type="text" class="form-control" placeholder="Name" style="width: 30%;"/>
                                                <select v-model="user.emergency.relation" class="form-select" style="width: 25%;">
                                                    <option value="" selected disabled>Select Religion</option>
                                ...
                                <div class="col-md-12">
                                    <div class="input-group me-2 mb-1" v-for="(field, index) in user.family.siblings" :key="index">
                                        ...
                                        <input type="text" class="form-control" placeholder="Occupation"
                                            style="width: 25%;" v-model="field.occupation" />
                                        <input type="text" class="form-control" placeholder="Company/School"
                                            style="width: 25%;" v-model="field.cs" />
                                        <button type="button" @click="removeSiblings(index)" class="btn btn-primary"> <i
                                                class='bx bx-trash'></i></button>
                                    </div>
                                </div>

                                <div class="col-md-12 mt-n2 mb-2" v-if="user.civil_status.id != 5 && user.civil_status != ''">
                                    <button @click="addC" class="btn btn-primary btn-sm" type="button"
                                        style="margin-bottom: -50px;">Add Children</button>
                                    <hr />
                                </div>
                                <div class="col-md-12" v-if="user.civil_status.id != 5">
        ...
        data() {
            return {
                ...
                user: {
                    ...
                    family: { parent:'', structure: '', siblings:[], childrens:[]}
                }
            }
        },
